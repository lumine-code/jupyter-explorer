...
// Deserializers run before package activation while a window is being restored.
// Prepare the singleton slot in the lifecycle hook guaranteed to precede them.
function initialize() {
  pane ??= null;
}
