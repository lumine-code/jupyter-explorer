...
class ExplorerPane {
  ...
  // The data in the grid belongs to a live kernel and cannot survive a window
  // reload. Persist only the pane's presence so it comes back as an empty shell.
  serialize() {
    return { deserializer: "jupyter-explorer/ExplorerPane" };
  }
