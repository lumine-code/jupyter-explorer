...
const DataExplorerSearchAdapter = require("./data-explorer-search");
...
print(__import__("json").dumps(_jupyter_data_explorer(), default=str))
del _jupyter_data_explorer
`;
}
...
class DataExplorerStore {
  ...
  getSearchAdapter = () => {
    if (!this.searchAdapter) {
      this.searchAdapter = new DataExplorerSearchAdapter(this);
    }
...
module.exports = { dataExplorerStore, DataExplorerStore, INDEX_COLUMN, buildSerializerCode };
